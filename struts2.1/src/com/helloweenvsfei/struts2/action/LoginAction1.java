 ...
 *  (例如： loginPerson1!login.action 、 loginPerson1!logout.action 等)直接執行這些非預定方法。
 */
public class LoginAction1 {
	...
	public String execute(){
	  System.out.println(LoginAction1.class.getName()+",execute() 執行了");
		 
	  System.out.println("********************************");
	  System.out.println(LoginAction1.class.getName());
	...
	public String login() throws Exception{
	  System.out.println(LoginAction1.class.getName()+",login() 執行了");
	...
	public String logout(){
      System.out.println(LoginAction1.class.getName()+",logout() 執行了");

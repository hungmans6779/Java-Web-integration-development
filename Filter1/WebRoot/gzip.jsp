...
<%!
  public void test(JspWriter out, String url) throws Exception {
	...
	out.println("	</tr>");
	out.println("	<tr>");
	out.println("		<td>壓縮前:" + lengthCommon + " byte</td>");
	out.println("		<td>壓縮後:" + lengthGzip + " byte</td>");
...
<html>
  ...
  <body>
    ...
    <%
      String [] urls = {
		                 "http://3w.eztravel.com.tw:8080/Filter1/dojo/dojo.js", 
		                 "http://localhost:8080/Filter1/winter.jpg", 
		                 "http://www.baidu.com", 

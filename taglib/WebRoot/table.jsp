...
<html>
  ...
  <%
	...
	person2.setAge(20);
	person2.setSex("男");
	person2.setAddress("北京市東皇城根錫拉胡同");
	...
	person3.setAge(20);
	person3.setSex("男");
	person3.setAddress("北京市東皇城根錫拉胡同");
	...
	person4.setAge(20);
	person4.setSex("女");
	person4.setAddress("北京市東皇城根錫拉胡同");
	...
	person5.setAge(20);
	person5.setSex("男");
	person5.setAddress("北京市東皇城根錫拉胡同");
	...
	person6.setAge(20);
	person6.setSex("女");
	person6.setAddress("北京市東皇城根錫拉胡同");
	...
	person7.setAge(20);
	person7.setSex("男");
	person7.setAddress("北京市海澱區海澱大街甲36號六層A");
...
%>
  ...
  <body>
    ...
    <taglib:table items="${personList}" url="table.jsp" >
      <taglib:column  property="id"         label="編號"     />
      <taglib:column  property="name"       label="姓名"     />
      <taglib:column  property="age"        label="年齡"     />
      <taglib:column  property="sex"        label="性別"     />
      <taglib:column  property="address"    label="地址"     />
      <taglib:column  property="telephone"  label="電話"     />
      <taglib:column  property="mobile"     label="手機"     />
      <taglib:column  property="city"       label="城市"     />
      <taglib:column  property="deleted"    label="是否刪除" />
    </taglib:table>

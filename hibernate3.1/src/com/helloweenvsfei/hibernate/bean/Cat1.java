...
@NamedQueries(value={ 
  @NamedQuery(name="all cat",query="select c from Cat1 c"),
  @NamedQuery(name="cat by name",query="select c from Cat1 c where c.name = :name "),
  @NamedQuery(name="cat by mother",query="select c from Cat1 c where c.mother.name =:name ")
})
...
public class Cat1 {
  ...
  public Cat1 getMother() {
	return mother;
  }


  public void setMother(Cat1 mother) {
	this.mother = mother;
  }
